...
email = ''
print()
print('Before we begin, please enter your name and email address.')
print()
name = input('Name: ')
print()
email = input('Email: ')
while '@' not in email:
  print()
  print('You have not entered a valid email address. (It must contain the @ symbol')
  print()
        ...
        if gallons >= 0:
            ...
            if pounds >= 0:
                ...
                if inches >= 0: 
                    ...
                    print()
                    print('Here are ', name, '\'s converted values:', sep='')
                    print()
